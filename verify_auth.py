...
def check_cors(service: str, url: str, origin: str = "http://localhost:3000") -> Tuple[bool, str]:
...
def main():
    ...
    if all_good:
        print(f"{Colors.GREEN}✓ All auth components are properly configured!{Colors.END}")
        print("\nYou can now:")
