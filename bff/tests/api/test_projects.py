...
class ProjectTestHelpers:
    ...
    def cleanup_projects(
        test_client: TestClient, auth_headers: Dict[str, str], project_ids: List[str]
    ) -> None:
...
class TestProjectCRUDOperations:
    ...
    def test_delete_project(
        ...
        locks_response = test_client.get(
    ...
    def test_create_projects_with_different_visibility(
        ...
        """
        project_data = ProjectTestHelpers.create_sample_project_data(
            name=f"Visibility Test {visibility}", visibility=visibility
        )
...
class TestProjectPermissions:
    ...
    @pytest.mark.unit
    def test_owner_can_perform_all_operations(self, test_client: TestClient) -> None:
        """
        ...
        """
        # Create owner user
        owner = ProjectTestHelpers.create_mock_user(
            "owner-123", "owner", "owner@example.com"
        )
        ...
        create_response = test_client.post(
            "/api/projects", json=project_data, headers=owner_headers
        )
        project_id = create_response.json()["project"]["id"]
        ...
        try:
            # Test read access
            response = test_client.get(
                f"/api/projects/{project_id}", headers=owner_headers
            )
            assert response.status_code == 200
            ...
            response = test_client.put(
                f"/api/projects/{project_id}", json=update_data, headers=owner_headers
            )
            assert response.status_code == 200
            ...
            response = test_client.get(
                f"/api/projects/{project_id}/collaborators", headers=owner_headers
            )
            assert response.status_code == 200

        finally:
            # Cleanup
            ProjectTestHelpers.cleanup_projects(
                test_client, owner_headers, [project_id]
            )

    @pytest.mark.unit
    def test_collaborator_has_limited_access(self, test_client: TestClient) -> None:
        """
        ...
        collaborator = ProjectTestHelpers.create_mock_user(
            "collab-456", "collaborator", "collab@example.com"
        )
        ...
        try:
            ...
            response = test_client.get(
                f"/api/projects/{project_id}", headers=collab_headers
            )
            assert response.status_code == 200
            ...
            response = test_client.get(
                f"/api/projects/{project_id}/collaborators", headers=collab_headers
            )
            assert response.status_code == 200
            ...
            response = test_client.put(
                f"/api/projects/{project_id}", json=update_data, headers=collab_headers
            )
    ...
    def test_non_member_has_no_access_to_private_project(
        ...
        non_member = ProjectTestHelpers.create_mock_user(
            "outsider-789", "outsider", "outsider@example.com"
        )
        ...
        try:
            ...
            response = test_client.get(
                f"/api/projects/{project_id}", headers=outsider_headers
            )
            assert response.status_code == 403
            ...
            response = test_client.get(
                f"/api/projects/{project_id}/collaborators", headers=outsider_headers
            )
            assert response.status_code == 403
    ...
    @pytest.mark.unit
    def test_public_project_visibility(self, test_client: TestClient) -> None:
        """
        ...
        viewer = ProjectTestHelpers.create_mock_user(
            "viewer-789", "viewer", "viewer@example.com"
        )
        ...
        try:
            ...
            response = test_client.get(
                f"/api/projects/{project_id}", headers=viewer_headers
            )
            assert response.status_code == 200
            ...
            update_data = {"name": "Unauthorized Update"}
            response = test_client.put(
                f"/api/projects/{project_id}", json=update_data, headers=viewer_headers
            )
            assert response.status_code == 403
...
class TestProjectStateManagement:
    ...
    def test_project_metadata_updates(
        ...
        project_data = ProjectTestHelpers.create_sample_project_data(
            name="Metadata Test", metadata=initial_metadata
        )
        create_response = test_client.post(
            "/api/projects", json=project_data, headers=auth_headers
        )
    ...
    def test_cascading_delete_cleanup(
        ...
        test_client.put(
            f"/api/projects/{project_id}/locks/cleanup_component",
            json=lock_data,
            headers=auth_headers,
        )
        ...
        collaborators_response = test_client.get(
            f"/api/projects/{project_id}/collaborators", headers=auth_headers
        )
    ...
    def test_project_limits_per_user(
        ...
        try:
            ...
            ProjectTestHelpers.cleanup_projects(
                test_client, auth_headers, created_projects
            )
...
class TestProjectCollaboration:
    ...
    @pytest.mark.unit
    def test_add_collaborator_to_project(self, test_client: TestClient) -> None:
        """
    ...
    @pytest.mark.unit
    def test_list_project_collaborators(self, test_client: TestClient) -> None:
        """
    ...
    @pytest.mark.unit
    def test_remove_collaborator_from_project(self, test_client: TestClient) -> None:
        """
        ...
        try:
            ...
            remove_response = test_client.delete(
                f"/api/projects/{project_id}/collaborators/{collaborator['id']}",
                headers=owner_headers,
            )
            ...
            self_remove_response = test_client.delete(
                f"/api/projects/{project_id}/collaborators/{collaborator['id']}",
                headers=collab_headers,
            )
    ...
    def test_collaboration_permission_restrictions(
        ...
        outsider = ProjectTestHelpers.create_mock_user(
            "outsider-789", "outsider", "outsider@example.com"
        )
        ...
        try:
            ...
            response = test_client.delete(
                f"/api/projects/{project_id}/collaborators/{outsider['id']}",
                headers=collab_headers,
            )
...
class TestProjectEdgeCases:
    ...
    def test_create_project_with_duplicate_name(
        ...
        try:
            ...
            # Cleanup
            ProjectTestHelpers.cleanup_projects(
                test_client, auth_headers, [first_project_id]
            )
    ...
    def test_update_nonexistent_project(
        ...
        response = test_client.put(
            f"/api/projects/{nonexistent_id}", json=update_data, headers=auth_headers
        )
    ...
    def test_sql_injection_and_xss_protection(
        ...
        response = test_client.post(
            "/api/projects", json=base_data, headers=auth_headers
        )
    ...
    def test_invalid_project_data_types(
        ...
        for invalid_data in invalid_data_sets:
            response = test_client.post(
                "/api/projects", json=invalid_data, headers=auth_headers
            )
        ...
        for semi_valid_data in semi_valid_data_sets:
            ...
            if response.status_code == 200:
                project_id = response.json()["project"]["id"]
                ProjectTestHelpers.cleanup_projects(
                    test_client, auth_headers, [project_id]
                )
    ...
    def test_project_operations_without_authentication(
        ...
        endpoints_to_test = [
            ...
            (
                "POST",
                f"/api/projects/{fake_project_id}/collaborators",
                {"user_id": "test"},
            ),
    ...
    def test_pagination_edge_cases(
        ...
        for params in test_cases:
            response = test_client.get(
                "/api/projects", params=params, headers=auth_headers
            )
