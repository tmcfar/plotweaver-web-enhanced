...
@router.put("/api/git/files/{project_id}/{file_path:path}", response_model=GitOperationResponse)
...
@router.delete("/api/git/files/{project_id}/{file_path:path}", response_model=GitOperationResponse)
...
async def create_commit(
    ...
    try:
        ...
        author_email = request.author_email or current_user.get("email", "unknown@example.com")
...
@router.put("/api/git/branches/{project_id}/switch", response_model=GitOperationResponse)
...
async def push_changes(
    ...
    try:
        ...
        if success:
            ...
            return GitOperationResponse(
                success=True,
                message=f"Changes pushed successfully to {request.remote}"
            )
        else:
