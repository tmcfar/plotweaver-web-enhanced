...
class GitRepoManager:
    ...
    def get_repo(self, project_id: str) -> git.Repo:
        ...
        if project_id not in self.repos:
            ...
            if repo_path.exists():
                ...
                raise HTTPException(
                    404, f"Repository not found for project {project_id}"
                )
    ...
    async def get_file_content(self, project_id: str, file_path: str) -> Dict[str, Any]:
        ...
        return {"content": content, "path": file_path, "last_commit": commit_info}
    ...
    async def pull_latest(self, project_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "error": str(e), "updated_files": []}

    async def get_diff(
        self, project_id: str, base_ref: str, head_ref: str = "HEAD"
    ) -> Dict[str, Any]:
    ...
    async def get_file_history(
        self, project_id: str, file_path: str, limit: int = 10
    ) -> List[Dict]:
