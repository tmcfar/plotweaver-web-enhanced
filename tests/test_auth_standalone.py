...
from src.auth.rate_limiter import RateLimitManager, RateLimitConfig, SlidingWindowRateLimiter
...
def test_manual_security_checks():
    ...
    assert jwt_secret == "your-secret-key-change-in-production"  # Should be changed in prod
